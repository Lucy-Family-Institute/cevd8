jQuery(window).on('load resize', function(){
    ...
    if((width) >= 991){
     ...
     jQuery('.item-container-principal-3.card-principal').on('click',function(){
         if(jQuery(this).hasClass('card-close') == false){
 ...
 function red(){
     ...
     jQuery('.card-second').addClass('recortado');
     jQuery('.card-first').addClass('recortado');
 }
 ...
 function blue(){
     ...
     jQuery('.card-second').removeClass('recortado');
     jQuery('.card-first').removeClass('recortado');
 }
